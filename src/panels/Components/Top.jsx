    ...
    <div>
        ...
        <div className={` whBlock ${otobrazhaemFemale? 'zero2' : ''}`}>
            ...
            <div className={styles.mean}>
                ...
                <p className={styles.pStyle}>В 2022 году некоторые имена снова становятся популярными. Например, имя Сергей ранее входило в десятку популярных, сейчас занимает 27 место, но по сравнению с тем же периодом 2021 года таким именем стали называть детей на 15% чаще. Также на 15% увеличилась популярность имени Адам. Такие имена как Николай, Григорий, Владислав, Никита, Егор и Степан наоборот утрачивают популярность по сравнению с прошлым годом. Среди необычных имен можно выделить иностранные имена Роберт , Даниэль, Марсель, Теодор, Лео. Среди мужских имен встречаются также древнеславянские или древнееврейские имена - Тихон, Серафим, Никон, Прохор.</p>
            </div>
            <div className={styles.mean}>
                {/* <Title><Icon20ArticleBoxOutline />Женские</Title> */}
